...
# helm install prometheus prometheus-community/kube-prometheus-stack --namespace monitoring --create-namespace -f $SETUP_DIR/prometheus_stack_values.yaml
...
run_command "python3 $SETUP_DIR/nodeIPs_test.py" "Ejecutando el script para configurar las IPs de los nodos"
...
run_command "helm install prometheus prometheus-community/kube-prometheus-stack --namespace monitoring --create-namespace -f $SETUP_DIR/prometheus_stack_values.yaml" "Instalando la stack de Prometheus"
